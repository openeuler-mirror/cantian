...
function install_cantiandb() {
    ...
    su - ${RUN_TEST_USER} -c "CTSQL_SSL_QUIET=TRUE ${TEST_DATA_DIR}/install/bin/ctsql sys/${SYS_PASSWD}@127.0.0.1:1611 -c 'select * from DV_VERSION' 2>&1"
...
function clear_old_install() {
    ...
    kill -9 $(pidof gssd)
    kill -9 $(pidof cms)
    rm -rf /home/regress/cantian_data/*  /home/cantiandba/data/*  /home/cantiandba/install/*  /data/data/*
