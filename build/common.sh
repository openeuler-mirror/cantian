...
CANTIAN_CI_PATH=${CODE_HOME_PATH}/ci
CANTIAN_HOME=${CODE_HOME_PATH}/pkg

CANTIAN_SRC=${CANTIAN_HOME}/src
CANTIAN_INSTALL=${CANTIAN_HOME}/install
CANTIAN_BUILD=${CODE_HOME_PATH}/build
CANTIAN_LIBRARY=${CODE_HOME_PATH}/library
CANTIAN_OPEN_SOURCE=${CODE_HOME_PATH}/open_source
CANTIAN_PLATFORM=${CODE_HOME_PATH}/platform
CANTIAN_OUTPUT=${CODE_HOME_PATH}/output
MYSQL_BINARY_CODE_PATH=${CODE_HOME_PATH}/library/mysql_pkg
CANTIAN_LIB=${CANTIAN_OUTPUT}/lib
CANTIAN_SYMBOL=${CANTIAN_OUTPUT}/symbol
CANTIAN_OBJ=${CANTIAN_OUTPUT}/obj
CANTIAN_BIN=${CANTIAN_OUTPUT}/bin

CT_SRC_BUILD_DIR=${CANTIAN_BUILD}/pkg/src
CT_TEST_BUILD_DIR=${CANTIAN_BUILD}/pkg/test
...
OPENSSL_LIB_PATH=${CANTIAN_LIBRARY}/openssl/lib
PCRE_LIB_PATH=${CANTIAN_LIBRARY}/pcre/lib
Z_LIB_PATH=${CANTIAN_LIBRARY}/zlib/lib
ODBC_LIB_PATH=${CANTIAN_LIBRARY}/odbc/lib
ZSTD_LIB_PATH=${CANTIAN_LIBRARY}/Zstandard/lib
LZ4_LIB_PATH=${CANTIAN_LIBRARY}/lz4/lib
SECUREC_LIB_PATH=${CANTIAN_LIBRARY}/security/lib
KMC_LIB_PATH=${CANTIAN_LIBRARY}/kmc/lib
XNET_LIB_PATH=${CANTIAN_LIBRARY}/xnet/lib
