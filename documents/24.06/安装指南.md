...
5.  将环境变量“export LD\_PRELOAD=/usr/local/lib/libjemalloc.so”添加至如下路径.bashrc文件的最后一行：“/home/_user_/.bashrc”。
    ...
    其中，“user”为[表1](部署Cantian引擎.md#zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_zh-cn_topic_0000001571256873_table111125312412)中参数deploy\_user配置的用户，例如：ctdba。
...
1.  切换cantian用户并登录ctsql。
    ...
    2.  执行以下命令，登录ctsql。
        ...
        请根据回显提示信息输入密码，该密码为[6](部署Cantian引擎.md#zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_zh-cn_topic_0000001571256873_li1417111015314)创建的数据库系统管理员sys用户的密码。
