...
4.  <a name="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_li168751833144317"></a>执行以下命令，上传Cantian引擎安装包并解压。
    ...
    其中，“path”为安装包的上传路径，“Installation Package”为《编译指南》的“版本编译”章节中编译生成的软件包。

    此处以软件包名称为“Cantian\_24.03\_x86\_64\_RELEASE.tgz”、将包放到目录“/ctdb/cantian\_install”为例进行说明。最终的参数配置以《编译指南》的“版本编译”中编译生成的软件包和实际的安装路径为准。
...
5.  <a name="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_li814413357016"></a>修改配置文件config\_params\_file.json，相关参数如[表1](#zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_zh-cn_topic_0000001571256873_table111125312412)所示。
    ...
    **表 1**  config\_params\_file.json文件参数说明
    ...
    <td class="cellrowborder" valign="top" width="80.13%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001801875845_p337153284816"><a name="zh-cn_topic_0000001801875845_p337153284816"></a><a name="zh-cn_topic_0000001801875845_p337153284816"></a>部署模式：请将部署模式设置为“nas”。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="80.13%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_zh-cn_topic_0000001571256873_p17104175314415"><a name="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_zh-cn_topic_0000001571256873_p17104175314415"></a><a name="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_zh-cn_topic_0000001571256873_p17104175314415"></a>cms共享数据使用的存储文件系统名称。该文件系统应在<a href="#ZH-CN_TOPIC_0000001803728162">配置存储网络</a>进行了创建，请填写创建该文件系统时使用的名称。</p>
    ...
    <td class="cellrowborder" valign="top" width="80.13%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_p426419153179"><a name="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_p426419153179"></a><a name="zh-cn_topic_0000001801875845_zh-cn_topic_0000001690212877_zh-cn_topic_0000001521308384_p426419153179"></a>挂载storage_archive_fs文件系统的逻辑端口的IP。该逻辑IP应在<a href="#ZH-CN_TOPIC_0000001803728162">配置存储网络</a>进行了设置，请填写设置的逻辑IP值。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="80.13%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001801875845_p1841320388507"><a name="zh-cn_topic_0000001801875845_p1841320388507"></a><a name="zh-cn_topic_0000001801875845_p1841320388507"></a>挂载storage_dbstore_fs文件系统的逻辑端口的IP。该逻辑IP应在<a href="#ZH-CN_TOPIC_0000001803728162">配置存储网络</a>进行了设置，请填写设置的逻辑IP值。</p>
    </td>
    </tr>
...
>![](public_sys-resources/icon-notice.gif) **须知：** 
>-   请根据《编译指南》的“编译源码”章节中生成的软件包版本类型（realase或debug版本），安装对应版本类型的MySQL。
