...
-   已[下载Cantian-Connector-MySQL源码](下载源码.md#ZH-CN_TOPIC_0000001852903501)。
...
-   已成功[构建或获取容器镜像](准备容器镜像.md#ZH-CN_TOPIC_0000001806024782)。
-   已[准备好所有源码](下载源码.md#ZH-CN_TOPIC_0000001852903501)。
