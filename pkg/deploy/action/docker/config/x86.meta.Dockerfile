...
COPY Cantian_connector_mysql_x86_64_RELEASE.tgz .
RUN tar -zxf Cantian.x86_64_RELEASE.tgz && rm -rf Cantian.x86_64_RELEASE.tgz &&
cp DBStor_Clientx86_64_RELEASE.tgz cantian_connector/repo &&
rm -rf DBStor_Client*_x86_64_RELEASE.tgz &&
...
tar -zxf /ctdb/cantian_install/Cantian_connector_mysql_x86_64_RELEASE.tgz &&
