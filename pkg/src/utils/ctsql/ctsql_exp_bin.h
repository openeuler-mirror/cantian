 ...
 *
 * IDENTIFICATION
 * src/utils/ctsql/ctsql_exp_bin.h
 *
 * -------------------------------------------------------------------------
 */
#ifndef __CTSQL_EXP_BIN_H__
#define __CTSQL_EXP_BIN_H__
...
#define CTSQL_EXP_BIN_MEM_BLOCK_SIZE          (uint32)(5 * 1024 * 1024)
#define CTSQL_EXP_BIN_MEM_BLOCK_RESERVED_SIZE (uint32)8
...
typedef struct st_exp_bin_records_mgr {
    ...
    char file_name[CT_MAX_FILE_PATH_LENGH];
