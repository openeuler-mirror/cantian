 ...
 *
 * IDENTIFICATION
 * src/utils/ctsql/ctsql_wsr_snap.c
 *
 * -------------------------------------------------------------------------
 */
...
int wsr_build_instance_snap_host(wsr_options_t *wsr_opts, ctconn_stmt_t *resultset, wsr_snap_t *wsr_snap,
    int *i_cnt)
{
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->snap_time, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->cpu_user, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->cpu_system, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->iowait, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->idle, MAX_WSR_ENTITY_LEN));
...
int wsr_build_instance_snap_session(wsr_options_t *wsr_opts, ctconn_stmt_t *resultset, wsr_snap_t *wsr_snap,
    int *i_cnt)
{
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->sessions, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->activesess, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->trans, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->longsql, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->longtrans, MAX_WSR_ENTITY_LEN));
...
int wsr_build_instance_snap_perf(wsr_options_t *wsr_opts, ctconn_stmt_t *resultset, wsr_snap_t *wsr_snap,
    int *i_cnt)
{
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->physical, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->logical, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->commit, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->rollback, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->redosize, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->execute, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->fetch, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->login, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->hardparse, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->dbwrpages, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->dbwrtime, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->redo_switch_count, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->pcr_construct_count, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->bcr_construct_count, MAX_WSR_ENTITY_LEN));
...
int wsr_build_instance_snap_sync(wsr_options_t *wsr_opts, ctconn_stmt_t *resultset, wsr_snap_t *wsr_snap,
    int *i_cnt)
{
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->minlog, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->minsyreply, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->maxlog, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->maxsyreply, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->minlgreply, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->maxlgreply, MAX_WSR_ENTITY_LEN));
...
int wsr_build_instance_snap_ts(wsr_options_t *wsr_opts, ctconn_stmt_t *resultset, wsr_snap_t *wsr_snap,
    int *i_cnt)
{
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->txn_pages, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->undo_pages, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->system, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->sysaux, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->users, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->arch_logs, MAX_WSR_ENTITY_LEN));
...
int wsr_build_instance_snap_event(wsr_options_t *wsr_opts, ctconn_stmt_t *resultset, wsr_snap_t *wsr_snap,
    int *i_cnt)
{
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->latch_data, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->filesync, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->busywaits, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->txrowlock, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->scattered, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->sequential, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->readother, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->archneeded, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->adlock, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->tableslock, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->switchin, MAX_WSR_ENTITY_LEN));
    CT_RETURN_IFERR(ctconn_column_as_string(*resultset, (*i_cnt)++, wsr_snap->itl_enq, MAX_WSR_ENTITY_LEN));
...
int wsr_build_instance_snap(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    CT_RETURN_IFERR(wsr_build_instance_snap_head(wsr_opts, wsr_info));
