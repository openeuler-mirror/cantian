 ...
 * -------------------------------------------------------------------------
 *
 * gsql_wsr_parameter.c
 *
 *
 * IDENTIFICATION
 * src/utils/gsql/gsql_wsr_parameter.c
 *
 * -------------------------------------------------------------------------
 */
...
int wsr_build_parameter(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_parameter_head(wsr_opts, wsr_info));
    ...
    do {
        ...
        GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, para_name, MAX_WSR_ENTITY_LEN));
        GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, begin_value, MAX_WSR_ENTITY_LEN));
        GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, end_value, MAX_WSR_ENTITY_LEN));
