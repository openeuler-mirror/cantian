 ...
 *
 * IDENTIFICATION
 * src/utils/gsql/gsql_wsr_segment.c
 *
 * -------------------------------------------------------------------------
 */
...
{
    uint32 index = 1;
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, wsr_segment_info->owner, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, wsr_segment_info->object_name,
        MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++,
        wsr_segment_info->subobject_name, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++,
        wsr_segment_info->tablespace_name, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, wsr_segment_info->object_type,
        MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, wsr_segment_info->value, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, index++, wsr_segment_info->rate, MAX_WSR_ENTITY_LEN));
    ...
    wsr_info_t *wsr_info, wsr_segment_info_t *wsr_segment_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_sql_query_segment_total(wsr_opts, wsr_info, statistics_id, &total_value));

    GS_RETURN_IFERR(wsr_build_segment_logicread_head(wsr_opts, wsr_info, total_value));
    ...
    GS_RETURN_IFERR(wsr_build_sql_query_segment(wsr_opts, wsr_info, statistics_id, total_value));
    ...
    do {
        ...
        GS_RETURN_IFERR(wsr_build_segment_one_row(wsr_opts, wsr_segment_info));
    ...
    wsr_info_t *wsr_info, wsr_segment_info_t *wsr_segment_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_segment_physicalread_head(wsr_opts, wsr_info, total_value));
    ...
    wsr_info_t *wsr_info, wsr_segment_info_t *wsr_segment_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_segment_physicalwrite_head(wsr_opts, wsr_info, total_value));
    ...
    wsr_segment_info_t *wsr_segment_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_sql_query_segment_total(wsr_opts, wsr_info, statistics_id, &total_value));
    GS_RETURN_IFERR(wsr_build_segment_rowlock_head(wsr_opts, wsr_info, total_value));
    ...
    wsr_info_t *wsr_info, wsr_segment_info_t *wsr_segment_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_sql_query_segment_total(wsr_opts, wsr_info, statistics_id, &total_value));
    GS_RETURN_IFERR(wsr_build_segment_itlwait_head(wsr_opts, wsr_info, total_value));
    ...
    wsr_info_t *wsr_info, wsr_segment_info_t *wsr_segment_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_sql_query_segment_total(wsr_opts, wsr_info, statistics_id, &total_value));
    GS_RETURN_IFERR(wsr_build_segment_bufferbusywait_head(wsr_opts, wsr_info, total_value));
...
int wsr_build_segment_stat(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_segment_logicread(wsr_opts, wsr_info, &wsr_segment_info_t));
    GS_RETURN_IFERR(wsr_build_segment_physicalread(wsr_opts, wsr_info, &wsr_segment_info_t));
    GS_RETURN_IFERR(wsr_build_segment_physicalwrite(wsr_opts, wsr_info, &wsr_segment_info_t));
    GS_RETURN_IFERR(wsr_build_segment_rowlock(wsr_opts, wsr_info, &wsr_segment_info_t));
    GS_RETURN_IFERR(wsr_build_segment_itlwait(wsr_opts, wsr_info, &wsr_segment_info_t));
    GS_RETURN_IFERR(wsr_build_segment_bufferbusywait(wsr_opts, wsr_info, &wsr_segment_info_t));
