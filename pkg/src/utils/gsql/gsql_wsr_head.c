 ...
 *
 * IDENTIFICATION
 * src/utils/gsql/gsql_wsr_head.c
 *
 * -------------------------------------------------------------------------
 */
#include "gsql_wsr_head.h"

int wsr_get_dbinfo_basic(wsr_options_t *wsr_opts, wsr_info_t *wsr_info, uint32 *index)
{
    uint32 *data = NULL;
    uint32 size;
    ...
    GS_RETURN_IFERR(gsc_get_column_by_id(wsr_opts->curr_stmt, (*index)++, (void **)&data, &size, &is_null));
    wsr_info->dbid = *data;
...
int wsr_get_dbinfo_host(wsr_options_t *wsr_opts, wsr_info_t *wsr_info, uint32 *index)
{
    uint32 *data = NULL;
    uint32 size;
    bool32 is_null = GS_FALSE;
...
int wsr_get_dbinfo_other(wsr_options_t *wsr_opts, wsr_info_t *wsr_info, uint32 *index)
{
    char str_buf[WSR_MAX_RECEV_LEN + 1] = { 0 };
    errno_t errcode;
    ...
    if (!cm_str_equal_ins(ptr1, ptr2)) {
        GS_THROW_ERROR(ERR_CLT_WSR_ERR, "Database restarts in the middle of two snapshots.");
        return GS_ERROR;
    }
...
int wsr_get_dbinfo_session(wsr_options_t *wsr_opts, wsr_info_t *wsr_info, uint32 *index)
{
    uint32 *data = NULL;
    uint32 size;
    bool32 is_null = GS_FALSE;
...
int wsr_get_dbinfo(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_get_dbinfo_basic(wsr_opts, wsr_info, &index));
    GS_RETURN_IFERR(wsr_get_dbinfo_host(wsr_opts, wsr_info, &index));
    GS_RETURN_IFERR(wsr_get_dbinfo_other(wsr_opts, wsr_info, &index));
    GS_RETURN_IFERR(wsr_get_dbinfo_session(wsr_opts, wsr_info, &index));
...
static int wsr_get_sysstat(wsr_options_t *wsr_opts, const char *stat_name, uint64 *stat_value)
{
    ...
    GS_RETURN_IFERR(gsc_prepare(wsr_opts->curr_stmt, cmd_sql));
    GS_RETURN_IFERR(gsc_bind_by_pos(wsr_opts->curr_stmt, index++, GSC_TYPE_INTEGER,
        &wsr_opts->start_snap_id, sizeof(uint32), NULL));
    GS_RETURN_IFERR(gsc_bind_by_pos(wsr_opts->curr_stmt, index++, GSC_TYPE_INTEGER,
        &wsr_opts->end_snap_id, sizeof(uint32), NULL));
    GS_RETURN_IFERR(gsc_bind_by_pos(wsr_opts->curr_stmt, index++, GSC_TYPE_STRING,
    ...
    if (gsc_get_column_by_id(wsr_opts->curr_stmt, 0, (void **)&data, &size, &is_null) != GS_SUCCESS) {
...
{
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sql executions", &wsr_info->executions));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sql execution total time", &wsr_info->dbtime));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sql execution cpu time", &wsr_info->cputime));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sql parses", &wsr_info->sql_parses));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sql hard parses", &wsr_info->hard_parse));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "disk reads", &wsr_info->disk_reads));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "disk read time", &wsr_info->disk_read_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "buffer gets", &wsr_info->buffer_gets));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sorts", &wsr_info->sorts));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sort on disk", &wsr_info->sort_on_disk));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "redo write size", &wsr_info->redo_size));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "commits", &wsr_info->transactions));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "rollbacks", &wsr_info->rollbacks));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "DBWR disk writes", &wsr_info->dbwr_disk_writes));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "user calls", &wsr_info->user_calls));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "sql parses time", &wsr_info->sql_parse_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "user logons cumulation", &wsr_info->user_logins));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "db block changes", &wsr_info->block_changes));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "redo writes", &wsr_info->redo_writes));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "redo space requests", &wsr_info->redo_space_requests));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "SELECT executions", &wsr_info->select_executions));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "SELECT execution time", &wsr_info->select_execution_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "UPDATE executions", &wsr_info->update_executions));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "UPDATE execution time", &wsr_info->update_execution_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "INSERT executions", &wsr_info->insert_executions));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "INSERT execution time", &wsr_info->insert_execution_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "DELETE executions", &wsr_info->delete_executions));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "DELETE execution time", &wsr_info->delete_execution_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "fetched counts", &wsr_info->fetched_counts));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "fetched rows", &wsr_info->fetched_rows));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "processed rows", &wsr_info->processed_rows));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "temporary tablespace allocates", &wsr_info->temp_allocates));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "cr gets", &wsr_info->cr_gets));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "DBWR disk writes", &wsr_info->dbwr_disk_writes));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "DBWR disk write time", &wsr_info->disk_write_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "redo write time", &wsr_info->redo_write_time));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total table creates", &wsr_info->table_create));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total table drops", &wsr_info->table_drop));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total table alters", &wsr_info->table_alter));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total table part drops", &wsr_info->table_part_drop));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total table subpart drops", &wsr_info->table_subpart_drop));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total histgram inserts", &wsr_info->histgram_insert));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total histgram updates", &wsr_info->histgram_update));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "total histgram deletes", &wsr_info->histgram_delete));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "undo buffer reads", &wsr_info->undo_buffer_reads));
    GS_RETURN_IFERR(wsr_get_sysstat(wsr_opts, "undo disk reads", &wsr_info->undo_disk_reads));
    return GSC_SUCCESS;
}
...
int wsr_build_header_db(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
...
int wsr_build_header_instance(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
...
int wsr_build_header_host(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
...
int wsr_build_header(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_header_db(wsr_opts, wsr_info));
    GS_RETURN_IFERR(wsr_build_header_instance(wsr_opts, wsr_info));
    GS_RETURN_IFERR(wsr_build_header_host(wsr_opts, wsr_info));
...
int wsr_build_load_profile_head(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
...
{
    GS_RETURN_IFERR(wsr_build_load_profile_head(wsr_opts, wsr_info));
...
int wsr_build_efficiency_html(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
...
int wsr_build_efficiency_latchhit(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    uint32 rows;
    int iret_sprintf;
    char cmd_buf[MAX_CMD_LEN + 1];
    gsc_stmt_t curr_stmt = wsr_opts->curr_stmt;
    ...
    GS_RETURN_IFERR(wsr_execute_sql(curr_stmt, &rows, cmd_buf));
    GS_RETURN_IFERR(gsc_column_as_string(curr_stmt, 0, wsr_info->latch_hit, MAX_WSR_DATE_LEN));
    return GSC_SUCCESS;
}

int wsr_build_efficiency_buffernowait(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    uint32 rows;
    int iret_sprintf;
    char cmd_buf[MAX_CMD_LEN + 1];
    ...
    PRTS_RETURN_IFERR(iret_sprintf);
    GS_RETURN_IFERR(wsr_execute_sql(curr_stmt, &rows, cmd_buf));
    GS_RETURN_IFERR(gsc_column_as_string(curr_stmt, 0, wsr_info->buffer_nowait, MAX_WSR_DATE_LEN));
    return GSC_SUCCESS;
}

int wsr_build_efficiency_libraryhit(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    uint32 rows;
    int iret_sprintf;
    char cmd_buf[MAX_CMD_LEN + 1];
    ...
    PRTS_RETURN_IFERR(iret_sprintf);
    GS_RETURN_IFERR(wsr_execute_sql(curr_stmt, &rows, cmd_buf));
    GS_RETURN_IFERR(gsc_column_as_string(curr_stmt, 0, wsr_info->library_hit, MAX_WSR_DATE_LEN));
    return GSC_SUCCESS;
}

int wsr_build_efficiency(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    GS_RETURN_IFERR(wsr_build_efficiency_latchhit(wsr_opts, wsr_info));
    GS_RETURN_IFERR(wsr_build_efficiency_buffernowait(wsr_opts, wsr_info));
    GS_RETURN_IFERR(wsr_build_efficiency_libraryhit(wsr_opts, wsr_info));
    GS_RETURN_IFERR(wsr_build_efficiency_html(wsr_opts, wsr_info));
    return GSC_SUCCESS;
}
...
int wsr_build_top_events(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_top_events_deal(wsr_opts));
...
int wsr_build_host_cpu(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, 0, wsr_info->cpu_idle, MAX_WSR_DATE_LEN));
    ...
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, 0, wsr_info->cpu_user, MAX_WSR_DATE_LEN));
    ...
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, 0, wsr_info->cpu_system, MAX_WSR_DATE_LEN));
    ...
    GS_RETURN_IFERR(gsc_column_as_string(wsr_opts->curr_stmt, 0, wsr_info->cpu_wio, MAX_WSR_DATE_LEN));
...
int wsr_build_host_mem(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_get_system(wsr_opts, "VM_PAGE_IN_BYTES", &vm_page_in_bytes));
    GS_RETURN_IFERR(wsr_get_system(wsr_opts, "VM_PAGE_OUT_BYTES", &vm_page_out_bytes));
