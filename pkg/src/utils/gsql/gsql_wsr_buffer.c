 ...
 *
 * IDENTIFICATION
 * src/utils/gsql/gsql_wsr_buffer.c
 *
 * -------------------------------------------------------------------------
 */
...
int wsr_build_instance_memory(wsr_options_t *wsr_opts, gsc_stmt_t *resultset, wsr_buffer_t *wsr_buffer,
    int *i_cnt)
{
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->snap_time, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->datadirty, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->datapin, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->datafree, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->tempfree, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->temphwm, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->tempswap, MAX_WSR_ENTITY_LEN));
    GS_RETURN_IFERR(gsc_column_as_string(*resultset, (*i_cnt)++, wsr_buffer->bufferdetail, MAX_WSR_DETAIL_LEN));
...
int wsr_build_instance_buffer(wsr_options_t *wsr_opts, wsr_info_t *wsr_info)
{
    ...
    GS_RETURN_IFERR(wsr_build_instance_buffer_head(wsr_opts, wsr_info));
