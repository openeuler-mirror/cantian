 ...
 *
 * IDENTIFICATION
 * src/utils/gsql/gsql_wsr_common.h
 *
 * -------------------------------------------------------------------------
 */
#ifndef __GSQL_WSR_COMMON_H__
#define __GSQL_WSR_COMMON_H__
...
typedef struct {
    ...
    uint32 header_len;
    FILE *wsr_dpfile;
    gsc_stmt_t curr_stmt;
    gsc_conn_t curr_conn;
