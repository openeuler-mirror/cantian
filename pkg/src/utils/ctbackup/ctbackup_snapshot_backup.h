...
*
* IDENTIFICATION
* src/utils/ctbackup/ctbackup_snapshot_backup.h
*
* -------------------------------------------------------------------------
 */

#ifndef CANTIANDB_CTBACKUP_SNAPSHOT_BACKUP_H
#define CANTIANDB_CTBACKUP_SNAPSHOT_BACKUP_H
...
#endif  // CANTIANDB_CTBACKUP_SNAPSHOT_BACKUP_H
