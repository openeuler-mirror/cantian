...
status_t cms_startup(void)
{
    ...
    CMS_LOG_INF("cms load keyfiles succ");
    CT_RETURN_IFERR(sigcap_handle_reg());
    CMS_LOG_INF("cms sigcap handle reg succ");
    CT_RETURN_IFERR(cms_load_gcc());
    CMS_LOG_INF("cms load gcc succ");
    CT_RETURN_IFERR(cms_update_local_cfg());
    CMS_LOG_INF("cms update local cfg succ");
    CT_RETURN_IFERR(cms_update_local_gcc());
    CMS_LOG_INF("cms update local gcc succ");
    CT_RETURN_IFERR(cms_instance_init());
    CMS_LOG_INF("cms instance init succ");
    CT_RETURN_IFERR(inc_stat_version());
    CMS_LOG_INF("cms inc stat ver succ");
    CT_RETURN_IFERR(record_io_stat_init());
    CMS_LOG_INF("cms record io stat init succ");
