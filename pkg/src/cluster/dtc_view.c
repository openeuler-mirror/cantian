...
dtc_view_mes_stat_t     g_mes_stat_array[GS_MAX_INSTANCES];
dtc_view_mes_elapsed_t  g_mes_elapsed_array[GS_MAX_INSTANCES];
dtc_view_mes_queue_t g_mes_queue_array[GS_MAX_INSTANCES];
dtc_view_node_info_t    g_node_info_array[GS_MAX_INSTANCES];
...
status_t dtc_view_buffer_ctrl_open(knl_handle_t session, knl_cursor_t *cursor)
{
    ...
    g_buffer_pos.is_next_inst = GS_FALSE;
...
knl_column_t g_converting_page_cnt_cols[] = {
    ...
    { 1, "CONVERTING_PAGE_COUNT", 0, 0, GS_TYPE_BIGINT, sizeof(uint64), 0, 0, GS_FALSE, 0, { 0 } },
    { 2, "INST_ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
};

knl_column_t g_buffer_ctrl_cols[] = {
    { 0, "ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 1, "ADDR", 0, 0, GS_TYPE_VARCHAR, ADDR_LEN, 0, 0, GS_FALSE, 0, { 0 } },           // Buffer ctrl address
    { 2, "TS#", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },      // tablespace number
    { 3, "FILE#", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },    // file id
    { 4, "DBABLK#", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },  // Page id
    { 5, "BA", 0, 0, GS_TYPE_VARCHAR, ADDR_LEN, 0, 0, GS_FALSE, 0, { 0 } },             // page address
    { 6, "INST_ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
...
knl_column_t g_mes_stat_cols[] = {
    { 0, "INST_ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 1, "MES_TYPE", 0, 0, GS_TYPE_CHAR, MAX_MES_TYPE_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 2, "DESCRIPTION", 0, 0, GS_TYPE_CHAR, GS_MAX_NAME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 3, "SEND", 0, 0, GS_TYPE_BIGINT, sizeof(uint64), 0, 0, GS_FALSE, 0, { 0 } },
    { 4, "SEND_FAIL", 0, 0, GS_TYPE_BIGINT, sizeof(uint64), 0, 0, GS_FALSE, 0, { 0 } },
    { 5, "LOCAL_COUNT", 0, 0, GS_TYPE_BIGINT, sizeof(uint64), 0, 0, GS_FALSE, 0, { 0 } },
    { 6, "RECV_PROCESS", 0, 0, GS_TYPE_BIGINT, sizeof(uint64), 0, 0, GS_FALSE, 0, { 0 } },
    { 7, "DEALING_COUNT", 0, 0, GS_TYPE_INTEGER, sizeof(int32), 0, 0, GS_FALSE, 0, { 0 } },
};

#define MAX_MES_QUEUE_LEN 10
knl_column_t g_mes_queue_cols[] = {
    { 0, "INST_ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 1, "GROUP_ID", 0, 0, GS_TYPE_CHAR, MAX_MES_GROUP_ID, 0, 0, GS_FALSE, 0, { 0 } },
    { 2, "QUEUE_LENGTH", 0, 0, GS_TYPE_CHAR, MAX_MES_QUEUE_LEN, 0, 0, GS_FALSE, 0, { 0 } },
};

#define MAX_MES_TASK_ID 4
knl_column_t g_mes_task_queue_cols[] = {
    { 0, "TASK_INDEX", 0, 0, GS_TYPE_INTEGER, MAX_MES_TASK_ID, 0, 0, GS_FALSE, 0, { 0 } },
    { 1, "QUEUE_LENGTH", 0, 0, GS_TYPE_INTEGER, MAX_MES_QUEUE_LEN, 0, 0, GS_FALSE, 0, { 0 } },
};

#define MAX_MES_TIME_LEN 45

knl_column_t g_mes_elapsed_cols[] = {
    { 0, "INST_ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 1, "MES_TYPE", 0, 0, GS_TYPE_CHAR, MAX_MES_TYPE_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 2, "GROUP_ID", 0, 0, GS_TYPE_CHAR, MAX_MES_GROUP_ID, 0, 0, GS_FALSE, 0, { 0 } },
    { 3, "DESCRIPTION", 0, 0, GS_TYPE_CHAR, 50, 0, 0, GS_FALSE, 0, { 0 } },
    { 4, "SEND", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 5, "SEND_IO", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 6, "SEND_ACK", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 7, "RECV", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 8, "GET_BUF", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 9, "READ_MESSAGE", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 10, "PUT_QUEUE", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 11, "GET_QUEUE", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 12, "PROCESS_FUNC", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 13, "BROADCAST", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 14, "BROADCAST_AND_WAIT", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 15, "MULTICAST", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 16, "MULTICAST_AND_WAIT", 0, 0, GS_TYPE_CHAR, MAX_MES_TIME_LEN, 0, 0, GS_FALSE, 0, { 0 } },
};
#define PIPE_TYPE_LEN 10
#define IP_TYPE_LEN 32
knl_column_t g_node_info_cols[] = {
    { 0, "INST_ID", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 1, "ADDRESS", 0, 0, GS_TYPE_VARCHAR, IP_TYPE_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 2, "INTERCONNECT_PORT", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 3, "TYPE", 0, 0, GS_TYPE_CHAR, PIPE_TYPE_LEN, 0, 0, GS_FALSE, 0, { 0 } },
    { 4, "CHANNEL_NUM", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
    { 5, "POOL_SIZE", 0, 0, GS_TYPE_INTEGER, sizeof(uint32), 0, 0, GS_FALSE, 0, { 0 } },
};
//COL_CNT of View
...
void dtc_view_get_time_stat(mes_time_consume_t * mes_elapsed_items)
{
    ...
    for (loop = 1; loop < MES_CMD_CEIL; loop++) {
        if (!dtc_view_elapsed_is_empty(loop)) {
            ...
            mes_elapsed_items[loop].non_empty = GS_TRUE;
        }
    }
    ...
    mes_elapsed_items[0].non_empty = GS_TRUE;
}
...
void dtc_view_get_mes_stat(mes_stat_t* mes_stat_items)
{
    ...
    for (loop = 1; loop < MES_CMD_CEIL; loop++) {
        if (mes_get_stat_send_count(loop) || mes_get_stat_recv_count(loop)) {
            ...
            mes_stat_items[loop].non_empty = GS_TRUE;
    ...
    mes_stat_items[0].non_empty = GS_TRUE;
}
...
void dtc_view_get_mes_queue(mes_queue_t *mes_queue_items)
{
    for (uint8 loop = 0; loop < MES_TASK_GROUP_ALL; loop++) {
        ...
        mes_queue_items[loop].non_empty = GS_TRUE;
    }
}
...
{
    dtc_view_req_t req;
    mes_init_send_head(&req.head, MES_CMD_GET_VIEW_INFO_REQ, sizeof(dtc_view_req_t), GS_INVALID_ID32, src_id, dest_id,
                       knl_session->id, GS_INVALID_ID16);
    req.view_id = view_id;
    status_t send_ret = mes_send_data((void *)&req);
    if (send_ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("send get_view_info_req failed, src_id %d dest_id %d view_id %d \n", src_id, dest_id, view_id);
        return send_ret;
    }
    status_t recv_ret = mes_recv(knl_session->id, msg, GS_FALSE, GS_INVALID_ID32, DTC_VIEW_GET_REMOTE_INFO_TIMEOUT);
    if (recv_ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("recv get_view_info_ack failed, src_id %d dest_id %d view_id %d \n", src_id, dest_id, view_id);
        return recv_ret;
    }

    if (msg->head->cmd == MES_CMD_GET_VIEW_INFO_ERROR_ACK) {
        GS_LOG_RUN_ERR("recv get view info error ack, src_id %d dest_id %d view_id %d \n", src_id, dest_id, view_id);
                                      ...
                                      uint8 dest_id)
{
    ...
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("get mes stat view req failed\n");
        return ret;
    }
...
static void  dtc_view_mes_stat_ack(knl_session_t *session, mes_message_t * receive_msg)
{
    ...
    mes_init_ack_head(receive_msg->head, &view_ack.head, MES_CMD_DTC_VIEW_INFO_ACK, sizeof(dtc_view_mes_stat_ack_t), GS_INVALID_ID16);
    ...
    if (mes_send_data((void*)&view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes_send_dtc_view_mes_stat_ack fail\n");
        return;
    }
    GS_LOG_RUN_INF("mes_send_dtc_view_mes_stat_ack success\n");
}
                                       ...
                                       uint8 dest_id)
{
    ...
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("get mes queue view req failed");
        return ret;
    }
...
static void dtc_view_mes_queue_ack(knl_session_t *session, mes_message_t *receive_msg)
{
    ...
    mes_init_ack_head(receive_msg->head, &queue_view_ack.head, MES_CMD_DTC_VIEW_INFO_ACK,
                      sizeof(dtc_view_mes_queue_ack_t), GS_INVALID_ID16);
    mes_release_message_buf(receive_msg->buffer);
    ...
    if (mes_send_data((void *)&queue_view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes_send_dtc_view_mes_queue_ack fail");
        return;
    }
    GS_LOG_RUN_INF("mes_send_dtc_view_mes_queue_ack success");
}
                                         ...
                                         uint8 dest_id)
{
    ...
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("get mes elapsed view req failed\n");
        return ret;
    }
...
static void dtc_view_mes_elapsed_ack(knl_session_t *session, mes_message_t * receive_msg)
{
    ...
    mes_init_ack_head(receive_msg->head, &view_ack.head, MES_CMD_DTC_VIEW_INFO_ACK, sizeof(view_ack), GS_INVALID_ID16);
    mes_release_message_buf(receive_msg->buffer);
    if (mes_send_data((void*)&view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes_send_dtc_view_mes_elapsed_ack fail\n");
        return;
    }
    GS_LOG_RUN_INF("mes_send_dtc_view_mes_elapsed_ack success\n");
}
                                       ...
                                       uint8 dest_id)
{
    ...
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("get node info view req failed\n");
        return ret;
    }
...
static void dtc_view_node_info_ack(knl_session_t *session, mes_message_t * receive_msg)
{
    ...
    mes_release_message_buf(receive_msg->buffer);
    if (mes_send_data((void*)&view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes_send_dtc_view_node_info_ack fail\n");
        return;
    }
    GS_LOG_RUN_INF("mes_send_dtc_view_node_info_ack success\n");
}
                                                     ...
                                                     uint8 dest_id)
{
    ...
    //remote info
    mes_init_send_head(&req.head, MES_CMD_DTC_VIEW_INFO_REQ, sizeof(dtc_view_req_t), GS_INVALID_ID32, src_id, dest_id,
                       knl_session->id, GS_INVALID_ID16);
    req.view_id = DYN_VIEW_DTC_CONVERTING_PAGE_CNT;

    if (mes_send_data((void *)&req) != GS_SUCCESS) {
        return GS_ERROR;
    }

    if (mes_recv(knl_session->id, &msg, GS_FALSE, GS_INVALID_ID32, DTC_VIEW_GET_REMOTE_INFO_TIMEOUT) != GS_SUCCESS) {
        return GS_ERROR;
    }
...
status_t dtc_view_mes_stat_open(knl_handle_t session, knl_cursor_t *cursor)
{
    ...
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes stat view open failed\n");
        return ret;
    }
...
status_t dtc_view_mes_queue_open(knl_handle_t session, knl_cursor_t *cursor)
{
    status_t ret = dtc_view_open(session, cursor);
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes queue view open failed");
        return ret;
    }
...
status_t dtc_view_mes_elapsed_open(knl_handle_t session, knl_cursor_t *cursor)
{
    status_t ret = dtc_view_open(session, cursor);
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("mes elapsed view open failed\n");
        return ret;
    }
...
status_t dtc_view_node_info_open(knl_handle_t session, knl_cursor_t *cursor)
{
    status_t ret = dtc_view_open(session, cursor);
    if (ret != GS_SUCCESS) {
        GS_LOG_RUN_ERR("node info view open failed\n");
        return ret;
    }
...
static status_t dtc_view_mes_stat_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, MES_STAT_COLS);
    GS_RETURN_IFERR(row_put_uint32(&ra, (uint32)g_mes_stat_array[node].inst_id));
    if (g_mes_stat_array[node].mes_stat[key].cmd == 0) {
        GS_RETURN_IFERR(row_put_str(&ra, "all"));
        GS_RETURN_IFERR(row_put_str(&ra, "all"));
    } else {
        char cmd[MAX_MES_TYPE_LEN];
        PRTS_RETURN_IFERR(sprintf_s(cmd, MAX_MES_TYPE_LEN, "%u", g_mes_stat_array[node].mes_stat[key].cmd));
        GS_RETURN_IFERR(row_put_str(&ra, cmd));
        char description[GS_MAX_NAME_LEN];
        PRTS_RETURN_IFERR(
            sprintf_s(description, GS_MAX_NAME_LEN, "%s", g_processors[g_mes_stat_array[node].mes_stat[key].cmd].name));
        GS_RETURN_IFERR(row_put_str(&ra, description));
    }

    GS_RETURN_IFERR(row_put_int64(&ra, (int64)g_mes_stat_array[node].mes_stat[key].send_count));
    GS_RETURN_IFERR(row_put_int64(&ra, (int64)g_mes_stat_array[node].mes_stat[key].send_fail_count));
    GS_RETURN_IFERR(row_put_int64(&ra, (int64)g_mes_stat_array[node].mes_stat[key].local_count));
    GS_RETURN_IFERR(row_put_int64(&ra, (int64)g_mes_stat_array[node].mes_stat[key].recv_count));
    GS_RETURN_IFERR(row_put_int32(&ra, (int32)g_mes_stat_array[node].mes_stat[key].dealing_count));
...
static status_t dtc_view_mes_queue_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, MES_QUEUE_COLS);
    GS_RETURN_IFERR(row_put_uint32(&ra, (uint32)g_mes_queue_array[node].inst_id));
    ...
    GS_RETURN_IFERR(row_put_str(&ra, group_id));
    ...
    GS_RETURN_IFERR(row_put_str(&ra, queue_len));
...
static status_t dtc_view_mes_task_queue_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, MES_TASK_QUEUE_COLS);

    GS_RETURN_IFERR(row_put_uint32(&ra, g_mes_task_queue_array.mes_task_queue[key].task_index));

    GS_RETURN_IFERR(row_put_uint32(&ra, g_mes_task_queue_array.mes_task_queue[key].queue_len));
...
static status_t dtc_view_get_elapsed_item(row_assist_t *ra, char *item, int len, int node, int key, int cmd)
{
    ...
    GS_RETURN_IFERR(row_put_str(ra, item));
    return GS_SUCCESS;
}
...
static status_t dtc_view_mes_elapsed_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, MES_ELAPSED_COLS);
    GS_RETURN_IFERR(row_put_uint32(&ra, (uint32)g_mes_elapsed_array[node].inst_id));
    if (g_mes_elapsed_array[node].func_time[key].cmd == 0) {
        ...
        GS_RETURN_IFERR(row_put_str(&ra, group_id));
        char description[GS_MAX_NAME_LEN];
        PRTS_RETURN_IFERR(sprintf_s(description, GS_MAX_NAME_LEN, "%s",
...
static status_t dtc_view_node_info_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, NODE_INFO_COLS);
    GS_RETURN_IFERR(row_put_uint32(&ra, (uint32)g_node_info_array[id].inst_id));
    GS_RETURN_IFERR(row_put_str(&ra, g_dtc->profile.nodes[id]));
    GS_RETURN_IFERR(row_put_uint32(&ra, g_dtc->profile.ports[id]));
    char type[PIPE_TYPE_LEN];
    dtc_view_get_pipe_type(g_node_info_array[id].pipe_type, type);
    GS_RETURN_IFERR(row_put_str(&ra, type));
    GS_RETURN_IFERR(row_put_uint32(&ra, (uint32)g_node_info_array[id].channel_num));
    GS_RETURN_IFERR(row_put_uint32(&ra, (uint32)g_node_info_array[id].mes_pool_size));
    id++;
    cursor->rowid.vmid = id;
    return GS_SUCCESS;
}
...
static status_t dtc_view_converting_page_cnt_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    if (ret != GS_SUCCESS) {  //if get converting page count error, skip it.
        inst_sequence++;
    ...
    row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, CONVERTING_PAGE_CNT_COLS);
    GS_RETURN_IFERR(row_put_int32(&ra, (int32)id));
    GS_RETURN_IFERR(row_put_int64(&ra, (int64)converting_page_cnt.converting_cnt));
    GS_RETURN_IFERR(row_put_int32(&ra, (int32)converting_page_cnt.inst_id));
    cm_decode_row((char *)cursor->row, cursor->offsets, cursor->lens, &cursor->data_size);
    inst_sequence++;
    cursor->rowid.vm_slot = inst_sequence;
    cursor->rowid.vmid++;
...
static void dtc_view_get_buffer_ctrl(knl_session_t *session, dtc_view_buffer_ctrls_t *buffer_ctrls)
{
    ...
    buffer_ctrls->is_next_inst = GS_FALSE;
    count = 0;
    GS_LOG_RUN_INF("dtc_view_get_buffer_ctrl: buf set id = %d\n,ctrl id = %d.\n", buffer_ctrls->buf_set_id,
                   buffer_ctrls->ctrl_id);
    if (buffer_ctrls->buf_set_id >= ctx->buf_set_count) {
        buffer_ctrls->is_next_inst = GS_TRUE;
        buffer_ctrls->buf_set_id = 0;
        buffer_ctrls->ctrl_id = 0;
        GS_LOG_RUN_INF("get max set id in current insatnce, switch to next instance.\n");
        return;
    }
    ...
    for (i = buffer_ctrls->ctrl_id; i < set->hwm; i++) {
        if (count == MAX_BUFFER_CTRL_PER_BUCKET) {
            ...
            GS_LOG_RUN_INF("fill one package, next ctrl id is %d.\n", i);
            return;
        }
        ctrl = &set->ctrls[i];
        page = ctrl->page;
    ...
    if (i == set->hwm) {
        if (buffer_ctrls->buf_set_id == ctx->buf_set_count - 1) {
            ...
            buffer_ctrls->ctrl_id = 0;
            buffer_ctrls->is_next_inst = GS_TRUE;
            GS_LOG_RUN_INF("buffer set %d reach to set->hwm, switch to next instance.\n", buffer_ctrls->buf_set_id);
        } else {
            buffer_ctrls->buf_set_id++;
            buffer_ctrls->ctrl_id = 0;
            GS_LOG_RUN_INF("switch to next buffer set %d.\n", buffer_ctrls->buf_set_id);
        }
    }
...
status_t dtc_view_get_buffer_ctrl_req(knl_session_t *knl_session, uint8 src_id)
{
    ...
    //remote info
    GS_LOG_RUN_INF("get infro: %d--->%d,bufset = %d,ctrl_id = %d.\n", src_id, g_buffer_pos.current_peer_inst_id, g_buffer_pos.buf_set_id, g_buffer_pos.ctrl_id);
    cm_sleep(100);

    mes_init_send_head(&req.head, MES_CMD_DTC_VIEW_BUFFER_CTRL_REQ, sizeof(dtc_view_buffer_ctrl_req_t), GS_INVALID_ID32,
                       src_id, g_buffer_pos.current_peer_inst_id, knl_session->id, GS_INVALID_ID16);
...
static status_t dtc_view_buffer_ctrl_fetch(knl_handle_t se, knl_cursor_t *cursor)
{
    ...
    if (g_buffer_pos.is_next_inst == GS_FALSE) {
        if (g_buffer_ctrls.buffer_ctrl_cnt == 0 || read_pos == g_buffer_ctrls.buffer_ctrl_cnt) {
            ...
            if (ret == GS_ERROR) { // send or receive error, go to next inst;
                g_buffer_pos.is_next_inst = GS_TRUE;
                return GS_SUCCESS;
            }
        }
    } else if (g_buffer_pos.is_next_inst == GS_TRUE && read_pos < g_buffer_ctrls.buffer_ctrl_cnt) {
    } else {
    ...
    if (read_pos < g_buffer_ctrls.buffer_ctrl_cnt) {
        char addr[ADDR_LEN];
        row_init(&ra, (char *)cursor->row, GS_MAX_ROW_SIZE, BUFFER_CTRL_COLS);
        sprintf_s(addr, ADDR_LEN, "%llx", g_buffer_ctrls.buffer_ctrl[read_pos].addr);
        GS_RETURN_IFERR(row_put_int32(&ra, (uint32)id));
        GS_RETURN_IFERR(row_put_str(&ra, addr));
        GS_RETURN_IFERR(row_put_int32(&ra, (uint32)g_buffer_ctrls.buffer_ctrl[read_pos].ts_num));
        GS_RETURN_IFERR(row_put_int32(&ra, (uint32)g_buffer_ctrls.buffer_ctrl[read_pos].file_num));
        GS_RETURN_IFERR(row_put_int32(&ra, (uint32)g_buffer_ctrls.buffer_ctrl[read_pos].dbablk_num));
        sprintf_s(addr, ADDR_LEN, "%llx", g_buffer_ctrls.buffer_ctrl[read_pos].ba);
        GS_RETURN_IFERR(row_put_str(&ra, addr));
        GS_RETURN_IFERR(row_put_int32(&ra, (int32)g_buffer_pos.current_peer_inst_id));
        cm_decode_row((char *)cursor->row, cursor->offsets, cursor->lens, &cursor->data_size);
...
static void dtc_view_get_converting_page_cnt_ack(knl_session_t *session, mes_message_t * receive_msg)
{
    ...
    mes_init_ack_head(receive_msg->head, &view_ack.head, MES_CMD_DTC_VIEW_CONVERTING_PAGE_CNT_ACK,
                      sizeof(dtc_view_converting_page_cnt_ack_t), GS_INVALID_ID16);
    uint8 src_id = receive_msg->head->dst_inst;
    GS_LOG_RUN_INF("src_inst = %d,converting_page_num =%d.", view_ack.converting_page_cnt.inst_id, view_ack.converting_page_cnt.converting_cnt);
    mes_release_message_buf(receive_msg->buffer);
    if (mes_send_data((void*)&view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("[GDV]: fail to send converting page cnt ack to %d.", src_id);
        return;
    }
    GS_LOG_RUN_INF("mes_send_data success.");
}
static void dtc_view_wrong_id_ack(knl_session_t *session, mes_message_t * receive_msg)
{
    ...
    mes_init_ack_head(receive_msg->head, &view_ack.head, MES_CMD_GET_VIEW_INFO_ERROR_ACK,
                      sizeof(dtc_view_wrong_id_ack_t), GS_INVALID_ID16);
    uint8 src_id = receive_msg->head->dst_inst;
    mes_release_message_buf(receive_msg->buffer);
    if (mes_send_data((void*)&view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("[GDV]: fail to send wrong view id err ack to %d.", src_id);
        return;
    }
    GS_LOG_RUN_INF("mes_send_data success.");
}
...
void dtc_view_process_get_buffer_ctrl_info(void *sess, mes_message_t * receive_msg)
{
    ...
    mes_init_ack_head(receive_msg->head, &view_ack.head, MES_CMD_DTC_VIEW_BUFFER_CTRL_ACK,
                      sizeof(dtc_view_buffer_ctrl_ack_t), GS_INVALID_ID16);
    dtc_view_get_buffer_ctrl(session, &view_ack.buffer_ctrls);
    mes_release_message_buf(receive_msg->buffer);
    if (mes_send_data((void *)&view_ack) != GS_SUCCESS) {
        GS_LOG_RUN_ERR("[GDV]: fail to send buffer ctrl data to %d.", src_id);
        return;
    }
    GS_LOG_RUN_INF("mes_send_data success.");
    return;
...
void dtc_view_process_get_view_info(void *sess, mes_message_t *receive_msg)
{
    ...
    GS_LOG_RUN_INF("Get DTC view request %d.", view_id);
