...
#define CT_MAX_CKPT_GROUP_SIZE 32768
...
#define CT_MAX_SNAPSHOT_BACKUP_RECYCLE_REDO_TIMEOUT (uint32)30
#define CT_MIN_SNAPSHOT_BACKUP_RECYCLE_REDO_TIMEOUT (uint32)1
