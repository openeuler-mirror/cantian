...
typedef enum en_cond_result { COND_FALSE = CT_FALSE, COND_TRUE = CT_TRUE, COND_UNKNOWN, COND_END } cond_result_t;
...
#define CT_STACK_DEPTH_THRESHOLD_SIZE                                                                                 \
    (CT_T2S_BUFFER_SIZE * 3 + CT_T2S_LARGER_BUFFER_SIZE + CT_MESSAGE_BUFFER_SIZE * 2 + SIZE_K(50)) /* __thread        \
                                                                                                      error_info_t in \
                                                                                                      cm_error.c */
