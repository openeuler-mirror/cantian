...
typedef enum en_param_global {
    ...
    PARAM_SQL_STAT,
    PARAM_SQL_STATISTIC_STAT,
    PARAM_SQL_STATISTIC_TIME_LIMIT,
    PARAM_INSTANCE_NAME,
    PARAM_ALARM_LOG_DIR,
    PARAM_REPL_ADDR,
    PARAM_REPL_PORT,
    ...
    PARAM_ENABLE_CANTIAN_STATS,
    PARAM_ENABLE_CTC_STATS,
    ...
    PARAM_CT_CLUSTER_STRICT_CHECK,
    PARAM_DRC_IN_REFORMER_MODE,
    PARAM_RES_RECYCLE_RATIO,
    PARAM_CREATE_INDEX_PARALLELISM,
    PARAM_ENABLE_DSS,
    PARAM_PREVENT_SNAPSHOT_BACKUP_RECYCLE_REDO,
    PARAM_PREVENT_SNAPSHOT_BACKUP_RECYCLE_REDO_TIMEOUT,
    PARAM_PREVENT_CREATE_SNAPSHOT,
    PARAM_CTSQL_READ_WRITE,
    PARAM_CEIL,
} param_global_t;
