...
config_item_t g_parameters[] = {
    ...
    ************************************************************************* */
    ...
    { "SQL_STATISTIC_STAT", CT_TRUE, ATTR_NONE, "FALSE", NULL, NULL, "-", "FALSE,TRUE", "CT_TYPE_BOOLEAN", NULL, PARAM_SQL_STATISTIC_STAT, 
      EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_bool, sql_notify_als_sql_statistic_stat, sql_notify_als_bool, NULL },
    { "SQL_STATISTIC_TIME_LIMIT", CT_TRUE, ATTR_NONE, "1000000", NULL, NULL, "-", "[0,4294967295]", "CT_TYPE_UINT32", NULL,
      PARAM_SQL_STATISTIC_TIME_LIMIT, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_uint32,
      sql_notify_als_sql_statistic_time_limit, NULL, NULL },
    ...
    { "ENABLE_CANTIAN_STATS", CT_TRUE, ATTR_NONE, "OFF", NULL, NULL, "-", "OFF,ON", "CT_TYPE_VARCHAR", NULL,
      PARAM_ENABLE_CANTIAN_STATS, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_onoff, sql_notify_cantian_stats,
      sql_notify_cantian_stats, NULL },
    { "ENABLE_CTC_STATS", CT_TRUE, ATTR_NONE, "OFF", NULL, NULL, "-", "OFF,ON", "CT_TYPE_VARCHAR", NULL,
      PARAM_ENABLE_CTC_STATS, EFFECT_IMMEDIATELY, CFG_INS, sql_verify_als_onoff, sql_notify_ctc_stats,
      sql_notify_cantian_stats, NULL },
    ...
    { "CT_CLUSTER_STRICT_CHECK", CT_TRUE, ATTR_NONE, "TRUE", NULL, NULL, "-", "FALSE,TRUE",
      "CT_TYPE_BOOLEAN", NULL, PARAM_CT_CLUSTER_STRICT_CHECK, EFFECT_IMMEDIATELY, CFG_INS,
