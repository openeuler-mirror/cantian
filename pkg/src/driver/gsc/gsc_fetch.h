 ...
 *
 * IDENTIFICATION
 * src/driver/gsc/gsc_fetch.h
 *
 * -------------------------------------------------------------------------
 */
#ifndef __GSC_FETCH_H__
#define __GSC_FETCH_H__
...
#define GSC_IS_TIMESTAMP_LTZ_TYPE(type) ((type) == GSC_TYPE_TIMESTAMP_LTZ)
