...
#define CTC_RESEND_MSG_INTERVAL (5)  // unit: ms
#define CTC_RESEND_MSG_TIMES (4000) // resend 200 times in 1s
#define CTC_BROADCAST_WAIT_TIMEOUT (12000)  // ms
#define CTC_CLUSTER_MAX_NODES (4)
#define CTC_DDL_PROCESSING (-99)
#define CTC_DDL_VERSION_NOT_MATCH (9999)
#define CTC_DDL_WAIT_PROCESS (100000)  // 100ms/0.1s
...
EXTER_ATTACK void dtc_proc_msg_ctc_invalidate_dd_req(void *sess, mes_message_t *msg);
status_t ctc_is_inst_alive(uint8 dst_inst);
