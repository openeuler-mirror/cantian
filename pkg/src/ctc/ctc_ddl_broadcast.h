 ...
 *
 * IDENTIFICATION
 * src/ctc/ctc_ddl_broadcast.h
 *
 * -------------------------------------------------------------------------
 */
#ifndef __CTC_DDL_BROADCAST_H__
#define __CTC_DDL_BROADCAST_H__
...
int ctc_broadcast_and_recv(knl_session_t *knl_session, uint64 inst_bits, const void *req_data, char *err_msg);
