...
knl_global_syncpoint_def g_knl_syncpoint[] = {
    ...
    { CANTIAN_REMASTER_CREATE_FREE_MIGRATE_PROC_FAIL, CT_FALSE, "REMASTER_CREATE_FREE_MIGRATE_PROC_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CANTIAN_REMASTER_CREATE_CLEAN_OWNER_PROC_FAIL, CT_FALSE, "REMASTER_CREATE_CLEAN_OWNER_PROC_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CANTIAN_REMASTER_CREATE_LOCKRES_RCY_PROC_FAIL, CT_FALSE, "REMASTER_CREATE_LOCKRES_RCY_PROC_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CANTIAN_REMASTER_CREATE_COLLECT_PAGEINFO_PROC_FAIL, CT_FALSE, "REMASTER_CREATE_COLLECT_PAGEINFO_PROC_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CANTIAN_REMASTER_CREATE_MIGRATE_RES_PROC_FAIL, CT_FALSE, "REMASTER_CREATE_MIGRATE_RES_PROC_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    ...
    { CANTIAN_DROP_DB_4MYSQL_AFTER_DROP_USER_DELAY, CT_FALSE, "DROP_DB_4MYSQL_AFTER_DROP_USER_DELAY", 0,
      knl_syncpoint_inject_delay, 0},
    { CTC_MES_UNLOCK_TABLE_SUCC_ABORT, CT_FALSE, "CTC_MES_UNLOCK_TABLE_SUCC_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_LOCK_TABLE_SUCC_ABORT, CT_FALSE, "CTC_LOCK_TABLE_SUCC_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_DDL_SUCC_ABORT, CT_FALSE, "CTC_DDL_SUCC_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_CLOSE_CONN_SUCC_ABORT, CT_FALSE, "CTC_CLOSE_CONN_SUCC_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_MES_OVERVIEW_SEND_FAIL, CT_FALSE, "CTC_MES_OVERVIEW_SEND_FAIL", 0, knl_syncpoint_inject_errcode, 0 },
    { CTC_MES_OVERVIEW_RECV_FAIL, CT_FALSE, "CTC_MES_OVERVIEW_RECV_FAIL", 0, knl_syncpoint_inject_errcode, 0 },
    { CTC_LOCK_TABLE_REMOTE_ABORT, CT_FALSE, "CTC_LOCK_TABLE_REMOTE_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_EXECUTE_DDL_REMOTE_ABORT, CT_FALSE, "CTC_EXECUTE_DDL_REMOTE_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_UNLOCK_REMOTE_ABORT, CT_FALSE, "CTC_UNLOCK_REMOTE_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_CLOSE_CONN_ABORT, CT_FALSE, "CTC_CLOSE_CONN_ABORT", 0, knl_syncpoint_inject_abort, 0 },
    { CTC_RENAME_CROSS_DB_AFTER_CREATE_TABLE_ABORT, CT_FALSE, "CTC_RENAME_CROSS_DB_AFTER_CREATE_TABLE_ABORT", 0,
        knl_syncpoint_inject_abort, 0 },
    { CTC_RENAME_CROSS_DB_AFTER_FILL_DATA_ABORT, CT_FALSE, "CTC_RENAME_CROSS_DB_AFTER_FILL_DATA_ABORT", 0,
        knl_syncpoint_inject_abort, 0 },
    { CTC_RENAME_CROSS_DB_AFTER_DROP_OLD_TABLE_ABORT, CT_FALSE, "CTC_RENAME_CROSS_DB_AFTER_DROP_OLD_TABLE_ABORT", 0,
        knl_syncpoint_inject_abort, 0 },
    { CTC_RENAME_CROSS_DB_FILL_PART_FAIL, CT_FALSE, "CTC_RENAME_CROSS_DB_FILL_PART_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_RENAME_CROSS_DB_FILL_FK_FAIL, CT_FALSE, "CTC_RENAME_CROSS_DB_FILL_FK_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_RENAME_CROSS_DB_FILL_INDEX_FAIL, CT_FALSE, "CTC_RENAME_CROSS_DB_FILL_INDEX_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_RENAME_CROSS_DB_DELAY, CT_FALSE, "CTC_RENAME_CROSS_DB_DELAY", 0, knl_syncpoint_inject_delay, 0},
    { CTC_RENAME_CROSS_DB_LOCK_USER_DELAY, CT_FALSE, "CTC_RENAME_CROSS_DB_LOCK_USER_DELAY", 0,
      knl_syncpoint_inject_delay, 0},
    ...
    {CANTIAN_SPC_OPEN_DATAFILE_FAIL, CT_FALSE, "CANTIAN_SPC_OPEN_DATAFILE_FAIL", 0,
        knl_syncpoint_inject_errcode, 0},
    { CTC_CREATE_TABLE_BEFORE_KNL_CREATE_ABORT, CT_FALSE, "CTC_CREATE_TABLE_BEFORE_KNL_CREATE_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_CREATE_TABLE_AFTER_KNL_CREATE_ABORT, CT_FALSE, "CTC_CREATE_TABLE_AFTER_KNL_CREATE_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_CREATE_TABLE_4MYSQL_FAIL, CT_FALSE, "CTC_CREATE_TABLE_4MYSQL_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_ALTER_TABLE_BEFORE_KNL_ALTER_ABORT, CT_FALSE, "CTC_ALTER_TABLE_BEFORE_KNL_ALTER_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_ALTER_TABLE_AFTER_KNL_ALTER_ABORT, CT_FALSE, "CTC_ALTER_TABLE_AFTER_KNL_ALTER_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_ALTER_TABLE_4MYSQL_FAIL, CT_FALSE, "CTC_ALTER_TABLE_4MYSQL_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_RENAME_TABLE_BEFORE_KNL_RENAME_ABORT, CT_FALSE, "CTC_RENAME_TABLE_BEFORE_KNL_RENAME_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_RENAME_TABLE_AFTER_KNL_RENAME_ABORT, CT_FALSE, "CTC_RENAME_TABLE_AFTER_KNL_RENAME_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_RENAME_TABLE_4MYSQL_FAIL, CT_FALSE, "CTC_RENAME_TABLE_4MYSQL_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_DROP_TABLE_BEFORE_KNL_DROP_ABORT, CT_FALSE, "CTC_DROP_TABLE_BEFORE_KNL_DROP_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_DROP_TABLE_AFTER_KNL_DROP_ABORT, CT_FALSE, "CTC_DROP_TABLE_AFTER_KNL_DROP_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_DROP_TABLE_4MYSQL_FAIL, CT_FALSE, "CTC_DROP_TABLE_4MYSQL_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    ...
    { CTC_CRETAE_TABLE_STATS_ACK_TIMEOUT, CT_FALSE, "CTC_CRETAE_TABLE_STATS_ACK_TIMEOUT", 0,
        knl_syncpoint_inject_delay, 0},
    { CTC_ALTER_TABLE_STATS_ACK_TIMEOUT, CT_FALSE, "CTC_ALTER_TABLE_STATS_ACK_TIMEOUT", 0,
        knl_syncpoint_inject_delay, 0},
    { CTC_RENAME_TABLE_STATS_ACK_TIMEOUT, CT_FALSE, "CTC_RENAME_TABLE_STATS_ACK_TIMEOUT", 0,
        knl_syncpoint_inject_delay, 0},
    { CTC_DROP_TABLE_STATS_ACK_TIMEOUT, CT_FALSE, "CTC_DROP_TABLE_STATS_ACK_TIMEOUT", 0, knl_syncpoint_inject_delay, 0},
    { CTC_COMMIT_LOG_PUT_FAIL, CT_FALSE, "CTC_COMMIT_LOG_PUT_FAIL", 0, knl_syncpoint_inject_errcode, 0 },
    ...
    { CANTIAN_DDL_TABLE_AFTER_COMMIT_ABORT, CT_FALSE, "DDL_TABLE_AFTER_COMMIT_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_BEFORE_INVALID_MYSQL_CACHE_ABORT, CT_FALSE, "CTC_BEFORE_INVALID_MYSQL_CACHE_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    { CTC_INVALID_MYSQL_CACHE_FAIL, CT_FALSE, "CTC_INVALID_MYSQL_CACHE_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_AFTER_INVALID_MYSQL_CACHE_ABORT, CT_FALSE, "CTC_AFTER_INVALID_MYSQL_CACHE_ABORT", 0,
      knl_syncpoint_inject_abort, 0 },
    ...
    { COLLECT_STATISTICS_PERSISTENCE_THROUGH_RESULT_FAIL, CT_FALSE, "COLLECT_STATISTICS_PERSISTENCE_THROUGH_RESULT_FAIL", 0,//
      knl_syncpoint_inject_errcode, 0 },
    { CTC_FILL_CBO_STATS_COL_FAIL, CT_FALSE, "CTC_FILL_CBO_STATS_COL_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { CTC_FILL_CBO_STATS_INDEX_FAIL, CT_FALSE, "CTC_FILL_CBO_STATS_INDEX_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
