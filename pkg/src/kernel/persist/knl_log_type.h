...
typedef enum st_logic_op {
    ...
    RD_SPC_SET_AUTOEXTEND_DAAC = 16,
    RD_SPC_RENAME_SPACE_DAAC = 17,
    RD_DATAFILE_EXTENT_SIZE = 18,
    RD_CREATE_SEQUENCE = 19,
    RD_DROP_SEQUENCE = 20,
    RD_ALTER_SEQUENCE = 21,
    RD_SPC_CHANGE_AUTOEXTEND_DAAC = 22,
    RD_CREATE_PROFILE = 23,
    RD_ALTER_PROFILE = 24,
    RD_DROP_PROFILE = 25,
    RD_SPC_SET_FLAG_DAAC = 26,
    ...
    RD_SPC_CREATE_SPACE_DAAC = 47,
    RD_SPC_REMOVE_SPACE_DAAC = 48,
    RD_SPC_CREATE_DATAFILE_DAAC = 49,
    RD_SPC_REMOVE_DATAFILE_DAAC = 50,
    RD_SPC_EXTEND_DATAFILE_DAAC = 51,
    RD_SPC_TRUNCATE_DATAFILE_DAAC = 52,
