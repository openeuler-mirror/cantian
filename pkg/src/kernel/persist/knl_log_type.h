...
typedef enum st_logic_op {
    ...
    RD_SPC_SET_AUTOEXTEND_CANTIAN = 16,
    RD_SPC_RENAME_SPACE_CANTIAN = 17,
    RD_DATAFILE_EXTENT_SIZE = 18,
    RD_CREATE_SEQUENCE = 19,
    RD_DROP_SEQUENCE = 20,
    RD_ALTER_SEQUENCE = 21,
    RD_SPC_CHANGE_AUTOEXTEND_CANTIAN = 22,
    RD_CREATE_PROFILE = 23,
    RD_ALTER_PROFILE = 24,
    RD_DROP_PROFILE = 25,
    RD_SPC_SET_FLAG_CANTIAN = 26,
    ...
    RD_SPC_CREATE_SPACE_CANTIAN = 47,
    RD_SPC_REMOVE_SPACE_CANTIAN = 48,
    RD_SPC_CREATE_DATAFILE_CANTIAN = 49,
    RD_SPC_REMOVE_DATAFILE_CANTIAN = 50,
    RD_SPC_EXTEND_DATAFILE_CANTIAN = 51,
    RD_SPC_TRUNCATE_DATAFILE_CANTIAN = 52,
    ...
    RD_CREATE_VIEW = 61,
    RD_REFRESH_DC = 62,
    RD_LOCK_TABLE_FOR_MYSQL_DDL = 63,
    RD_UNLOCK_TABLE_FOR_MYSQL_DDL = 64,
    RD_INVALID_DD_FOR_MYSQL_DDL = 65,
